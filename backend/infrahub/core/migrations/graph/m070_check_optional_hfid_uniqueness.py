...
class Migration070(InternalSchemaMigration):
    """
    Reports pre-existing schemas that violate the new validation requiring attributes referenced
    in human_friendly_id or uniqueness_constraints to be mandatory or have a default_value.

    Deployments that have optional attributes (with no default_value) referenced in these
    ...
    name: str = "070_check_optional_hfid_uniqueness"
